...
Uses the shared GAOptimizer class which encapsulates NSGA-II selection,
day-aligned crossover, per-gene mutation with constraint repair,
and a ParetoFront to track non-dominated solutions.
...
def train_ga(
    ...
    config = EnvironmentConfig(
        unavailability=unavail_set or set(),
    )
