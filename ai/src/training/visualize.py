"""Streamlit visualization for a trained SB3 model.

Loads a checkpoint, runs inference, and displays the schedule as a table
with a shift-distribution bar chart.

Usage:
    streamlit run src/training/visualize.py
"""
...
from agents.registry import ModelRegistry
