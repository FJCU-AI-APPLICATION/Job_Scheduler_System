...
class SchedulingProblem(BaseModel):
    ...
    Provides a single source of truth for problem parameters, derived from
    either an EnvironmentConfig (for training) or a SchedulingRequest (for inference).
    """
...
class ScheduleConverter:
    ...
    def to_assignments(
        ...
        """Convert a flat schedule (list of employee indices) to assignments and hours.
