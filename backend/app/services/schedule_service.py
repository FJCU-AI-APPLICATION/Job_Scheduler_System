...
from app.models.employee import EmployeeUnavailability
from app.models.policy import ShiftPolicy
from app.models.schedule import Schedule, ScheduleEmployee
from app.schemas.schedule import ComputeScheduleRequest, ConfirmScheduleRequest
...
async def compute_schedule(
    ...
    # Get shift details for the policy
    ...
    # Batch-query all unavailabilities for requested employees
...
async def confirm_schedule(
    ...
    """Persist a computed schedule to the database. Returns created schedule IDs."""
